...
@Getter @Setter
public class Shard1DataSourceProperties implements BeanClassLoaderAware, InitializingBean {
    ...
    public Shard1DataSourceProperties() {
    }
    ...
    public String determineDriverClassName() {
        if (StringUtils.hasText(this.driverClassName)) {
            ...
            if (!StringUtils.hasText(driverClassName)) {
                throw new Shard1DataSourceProperties.DataSourceBeanCreationException("Failed to determine a suitable driver class", this, this.embeddedDatabaseConnection);
            } else {
    ...
    public String determineUrl() {
        if (StringUtils.hasText(this.url)) {
            ...
            if (!StringUtils.hasText(url)) {
                throw new Shard1DataSourceProperties.DataSourceBeanCreationException("Failed to determine suitable jdbc url", this, this.embeddedDatabaseConnection);
            } else {
                return url;
            }
        }
    ...
    static class DataSourceBeanCreationException extends BeanCreationException {
        private final Shard1DataSourceProperties properties;
        private final EmbeddedDatabaseConnection connection;

        DataSourceBeanCreationException(String message, Shard1DataSourceProperties properties, EmbeddedDatabaseConnection connection) {
            super(message);
            this.properties = properties;
            this.connection = connection;
        }

        Shard1DataSourceProperties getProperties() {
            return this.properties;
        }
