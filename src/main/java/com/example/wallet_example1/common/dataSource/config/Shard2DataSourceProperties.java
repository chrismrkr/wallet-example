...
@Getter @Setter
public class Shard2DataSourceProperties {
    ...
    public Shard2DataSourceProperties() {
    }
    ...
    public String determineDriverClassName() {
        if (StringUtils.hasText(this.driverClassName)) {
            ...
            if (!StringUtils.hasText(driverClassName)) {
                throw new Shard2DataSourceProperties.DataSourceBeanCreationException("Failed to determine a suitable driver class", this, this.embeddedDatabaseConnection);
            } else {
    ...
    public String determineUrl() {
        if (StringUtils.hasText(this.url)) {
            ...
            if (!StringUtils.hasText(url)) {
                throw new Shard2DataSourceProperties.DataSourceBeanCreationException("Failed to determine suitable jdbc url", this, this.embeddedDatabaseConnection);
            } else {
                return url;
            }
        }
    ...
    static class DataSourceBeanCreationException extends BeanCreationException {
        private final Shard2DataSourceProperties properties;
        private final EmbeddedDatabaseConnection connection;

        DataSourceBeanCreationException(String message, Shard2DataSourceProperties properties, EmbeddedDatabaseConnection connection) {
            super(message);
            this.properties = properties;
            this.connection = connection;
        }

        Shard2DataSourceProperties getProperties() {
            return this.properties;
        }
